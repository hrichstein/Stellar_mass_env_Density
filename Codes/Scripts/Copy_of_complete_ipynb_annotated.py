...
dirpath  = r"C:\Users\Hannah\Desktop\Vanderbilt_REU\Stellar_mass_env_density\Catalogs\Resolve_plk_5001_so_mvir_hod1_ECO_Mocks"
usecols  = (0,1,8,13)
...
PD       = [(pd.read_csv(ECO_cats[ii],sep="\s+", usecols= usecols,header=None,\
				   skiprows=1,names=names)) for ii in range(len(ECO_cats))]
